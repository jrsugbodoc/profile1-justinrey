			...
			<div class="box-widget widget-user">
				<div class="widget-user-image d-sm-flex">
					<img alt="User Avatar" class="rounded-circle border p-0"
						src="<?php echo base_url('assets/images/users/16.jpg'); ?>">
					...
					<div class="card">
						<div class="card-body">
							...
							<div class="main-profile-bio mb-0">
								...
								<p class="mb-0">pleasure rationally encounter but because pursue consequences that are
									extremely painful.occur in which toil and pain can procure him some great pleasure..
									<a href="">More</a></p>
							</div>
						</div>
				...
				<div class="tab-pane" id="tab-8">
					<div class="card p-5">
						<div class="row">
							...
							<div class="col-md-12">
								<a class="btn btn-block btn-light" href="#"><i class="fe fe-chevron-down"></i> See
									All</a>
							</div>
						</div>
					</div>
					...
					<ul class="timelineleft pb-5">
						...
						<?php if ($posts->category === 'text'): ?>
							...
							<div class="timelineleft-item">
								<span class="time"><i
										class="fa fa-clock-o text-danger"></i><?php echo $time_since_posted; ?></span>
